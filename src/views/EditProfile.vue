<template>
    <div class="edit-profile">
      <div class="profile-photo">
        ...
        <div class="photo-text">プロフィール写真を設定する</div>
      ...
      <div v-if="showModal" class="modal-container">
        <div class="modal-content" @click.stop>
          <div class="rectangle-div">
            ...
            <input 
              v-model="profile[currentField.id]" 
              type="text" 
  ...
  export default defineComponent({
    ...
    setup() {
      ...
      const profile = reactive({
        hashtag: 'training',
        username: 'seika_tamukai',
        bio: 'nutsモデルの田向星華です。',
        age: '22歳'
      });
  
      const fields = [
        { id: 'hashtag', label: '#', placeholder: 'training' },
        { id: 'username', label: 'ID', placeholder: 'seika_tamukai' },
        { id: 'bio', label: 'profile', placeholder: 'nutsモデルの田向星華です。' },
        { id: 'age', label: 'age', placeholder: '22歳' }
      ];
